...
| 实验 | MR | 校准 | Adaptive k/p | k | Top-1 | 关键结论 |
|:----:|:--:|:---:|:------------:|:-:|:-----:|:--------|
| B3 (+Fisher-MR) | ✅ | MSE | ✗ | 5 | 56.82% | MR 在 3-bit 下提供稳定增益 |
| C3 (+Fisher-Calib) | ✗ | Fisher | ✗ | 5 | 56.40% | Fisher 校准单独有效，但弱于 MR |
| D3 (MR + Fisher-Calib) | ✅ | Fisher | ✗ | 5 | 56.68% | 校准后精度提升，但后续重建存在收益抵消 |
| E3 (+Adaptive) | ✗ | MSE | ✅ | 8 | 55.99% | Adaptive 单独不如 MR |
| **B+E (推荐)** | ✅ | MSE | ✅ | 8 | **56.92%** | **3-bit 当前最佳：MR 与 Adaptive 互补** |

**关键发现**：
- **MR 是 3-bit 的核心增益来源**：B3 相比 C3/E3 更稳定，说明低比特下先修正 MLP 非线性误差非常重要。
- **Adaptive k/p 与 MR 互补**：B+E 在 B3 基础上进一步提升到 56.92%，说明自适应 Fisher-DPLR 更适合在 MR 修正后的模型上发挥作用。
